...
public class SmsDemo {
	...
	static final String accessKeyId = "LTAIf7UESqSDbOOB";
	static final String accessKeySecret = "MBPgsrFWMx3zi9WKWvgyFIihzIOmCt";

	public static SendSmsResponse sendSms(String PhoneNumber, String number)
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("攒个车平台");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_136393694");
	...
	public static QuerySendDetailsResponse querySendDetails(String bizId)
		...
		// 必填-号码
		request.setPhoneNumber("15387876464");
		// 可选-流水号
	...
	public static void main(String[] args) throws ClientException,
		...
		// 发短信
		SendSmsResponse response = sendSms("18570378445", "1234");
